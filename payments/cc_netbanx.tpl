{*
$Id: cc_netbanx.tpl,v 1.19 2009/09/01 12:07:05 igoryan Exp $
...
<option value="GBP"{if $module_data.param04 eq "GBP"} selected="selected"{/if}>United Kingdom Pound</option>
