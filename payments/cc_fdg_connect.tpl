{*
$Id: cc_fdg_connect.tpl,v 1.3 2009/09/01 12:07:05 igoryan Exp $
...
<td><input type="password" name="param06" id="shared_secret" size="32" value="{$module_data.param06|escape}" /></td>
</tr>
