{*
$Id: cc_mbookers.tpl,v 1.17 2009/07/23 11:33:34 igoryan Exp $
...
<td width="40%"><input type="text" name="param06" size="32" value="{$module_data.param06|default:"`$https_location`/skin1/images/xlogo.gif"|escape}" /></td>
</tr>
