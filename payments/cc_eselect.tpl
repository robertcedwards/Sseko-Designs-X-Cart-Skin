{*
$Id: cc_eselect.tpl,v 1.20 2009/09/15 10:59:32 igoryan Exp $
...
<td>
<select name="cmpi">
<option value="B"{if $module_data.cmpi eq "B"} selected="selected"{/if}>On</option>
<option value=""{if $module_data.cmpi eq ""} selected="selected"{/if}>Off</option>
</select>
</td>
</tr>
</table>
