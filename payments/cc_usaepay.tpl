{*
$Id: cc_usaepay.tpl,v 1.16 2009/05/21 06:20:37 max Exp $
...
<tr>
  ...
  <td>
    <select name="testmode">
      ...
      <option value="S"{if $module_data.testmode eq "S"} selected="selected"{/if}>{$lng.lbl_cc_testlive_sandbox}
      <option value="L"{if $module_data.testmode eq "L"} selected="selected"{/if}>{$lng.lbl_cc_testlive_sandbox_live}
    </select>
  </td>
</tr>
