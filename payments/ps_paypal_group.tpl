{*
$Id: ps_paypal_group.tpl,v 1.25 2009/10/30 12:41:27 max Exp $
...
<script type="text/javascript" src="{$SkinDir}/payments/ps_paypal_group.js"></script>
          ...
          <table cellpadding="5" cellspacing="5" width="100%" id="paypal-settings">
            ...
            <tr valign="top">
              ...
              <td>
                ...
                <a href="javascript:void(0);" onclick="javascript:window.open('http://www.x-cart.com/xcart_manual/online/paypal3.htm','PPEC_HELP');">{$lng.lbl_paypal_guidelines_click}</a>
                </td>
            </tr>
