{*
$Id: ps_paypal_express.tpl,v 1.2.2.1 2009/12/17 09:36:04 ferz Exp $
...
<table cellspacing="10">
  ...
  <tr>
    <td><input type="radio" name="paypal_express_method" value="email" id="method_email"{if $config.paypal_express_method ne 'api'} checked="checked"{/if} onclick="javascript: changeExpressMethod();" /></td>
    <td width="100%"><label for="method_email">{$lng.txt_paypal_express_email_note}</label>:</td>
    <td><input type="text" name="paypal_express_email" value="{$config.paypal_express_email|default:$default_paypal_email|escape}" id="express_email" size="40" /></td>
  </tr>

  <tr>
    <td><input type="radio" name="paypal_express_method" value="api" id="method_api"{if $config.paypal_express_method eq 'api'} checked="checked"{/if} onclick="javascript: changeExpressMethod();" /></td>
    <td colspan="2"><label for="method_api">{$lng.txt_paypal_express_api_note}</label>:<br />{$lng.txt_paypal_express_api_smallnote}</td>
  </tr>

  <tr>
    <td colspan="3" id="api_settings">
