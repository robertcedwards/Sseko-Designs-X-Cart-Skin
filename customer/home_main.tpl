{*
$Id: home_main.tpl,v 1.29.4.1 2010/02/01 08:20:49 aim Exp $
...
{elseif $main eq "search" || $main eq "advanced_search"}
{include file="customer/main/search_result.tpl"}

{elseif $main eq "cart"}
{include file="customer/main/cart.tpl"}

{elseif ($main eq "comparison" || $main eq 'choosing') && $active_modules.Feature_Comparison}
{include file="modules/Feature_Comparison/common.tpl"}

{elseif $main eq "wishlist" && $active_modules.Wishlist}
...
{elseif $active_modules.Gift_Registry ne "" && $main eq "giftreg"}
...
{elseif $main eq "need_login" || $main eq "login_incorrect" || $main eq "antibot_error" || $main eq "disabled"}
{include file="customer/main/error_login.tpl" is_remember="Y"}
