{*
$Id: search_orders.tpl,v 1.14 2009/04/23 11:35:03 max Exp $
...
-->
      ...
      <div id="adv_search_box"{if $js_enabled eq 'Y' and !$search_prefilled.need_advanced_options} style="display: none;"{/if}>
