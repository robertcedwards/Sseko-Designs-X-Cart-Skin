{*
$Id: general.tpl,v 1.25 2009/05/18 08:26:27 igoryan Exp $
...
{if $config.Shipping.realtime_shipping ne "Y" and $shipping_rates_count le "0" && $config.Shipping.enable_shipping eq "Y"}
<tr>
  <td colspan="2">
