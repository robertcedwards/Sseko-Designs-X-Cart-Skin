{*
$Id: shipping_rates.tpl,v 1.54 2009/09/01 12:07:05 igoryan Exp $
...
<tr>
  ...
  <td align="right">
    ...
    <option value="DST"{if $shipping_method.apply_to eq "DST" || $shipping_method.apply_to eq ""} selected="selected"{/if}>DST ({$lng.lbl_discounted_subtotal})</option>
    <option value="ST"{if $shipping_method.apply_to eq "ST"} selected="selected"{/if}>ST ({$lng.lbl_subtotal})</option>
    </select>
  </td>
</tr>
</table>
...
<tr>
  ...
  <select name="apply_to_new">
    <option value="DST" selected="selected">DST ({$lng.lbl_discounted_subtotal})</option>
    <option value="ST">ST ({$lng.lbl_subtotal})</option>
  </select>
  </td>
</tr>
