{*
$Id: edit_giftcerts.tpl,v 1.13 2009/04/18 06:33:04 max Exp $
...
<tr>
  ...
  <td valign="top">{if $giftcert.deleted}{include file="currency.tpl" value=$giftcert.amount}{else}<input type="text" name="giftcert_details[{%gc.index%}][amount]" size="15" maxlength="15" value="{$giftcert.amount|formatprice}" />{/if}</td>
  <td valign="top">{include file="currency.tpl" value=$orig_giftcert.amount}</td>
</tr>
