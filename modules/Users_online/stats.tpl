{*
$Id: stats.tpl,v 1.14 2009/09/09 08:12:04 igoryan Exp $
...
<tr>
  ...
  <tr{cycle values=", class=TableSubHead" name=$v.last_date}>
    ...
    <tr>
      <td>{$p.amount} x {include file="currency.tpl" value=$p.price} = {if $p.price gt 0}{multi assign="total" x=$p.amount y=$p.price}{else}{assign var="total" value=0}{/if}{include file="currency.tpl" value=$total}</td>
    </tr>
    </table>
