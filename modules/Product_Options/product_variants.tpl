{*
$Id: product_variants.tpl,v 1.41 2009/05/27 14:11:00 igoryan Exp $
...
<tr class="TableHead">
  ...
  {if $wp.quantity gt 1 || $wp.membershipid gt 0}
<tr>
...
<br /><br />
<center><input type="button" value="{$lng.lbl_update|strip_tags:false|escape}" onclick="javascript: this.form.submit();" /></center>
