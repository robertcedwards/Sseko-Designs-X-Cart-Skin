{*
$Id: add_product_options.tpl,v 1.20 2009/09/01 12:07:04 igoryan Exp $
...
{if $product.product_type ne 'C'}
  <option value=''{if $product_option.is_modifier eq '' && $product_option.classid gt 0} selected="selected"{/if}>{$lng.lbl_variant}</option>
{/if}
  <option value='T'{if $product_option.is_modifier eq 'T' && $product_option.classid gt 0} selected="selected"{/if}>{$lng.lbl_text_field}</option>
  </select></td> 
</tr>
<tr>
