{*
$Id: check_options.tpl,v 1.83 2009/10/13 05:44:28 joy Exp $
...
product_image.src = "{if $product.images.P.url && (not $product.images.P.is_default || $product.images.T.is_default)}{$product.images.P.url}{elseif $product.images.T.url && $product.images.P.is_default && not $product.images.T.is_default}{$product.images.T.url}{else}{if $full_url}{$http_location}{else}{$xcart_web_dir}{/if}/image.php?id={$product.productid}&type=P{/if}";
