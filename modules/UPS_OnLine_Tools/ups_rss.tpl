{*
$Id: ups_rss.tpl,v 1.33 2009/09/18 06:12:18 joy Exp $
...
function switchUPSDim(s) {
  ...
  s.form.weight.disabled = s.options[s.selectedIndex].value != '02';
}
$.event.add(
  window,
  'load',
...
<br />
{if $countries}
<script type="text/javascript" src="{$SkinDir}/main/two_select_boxes.js"></script>
{/if}
...
<tr>
  ...
  <td valign="top">
    <input type="text" name="weight" value="{$shipping_options.rss.weight}" style="width: 200px;"{if $require_dimensions ne "Y"} disabled="disabled"{/if} /> 
  </td>
</tr>
...
<tr>
  <td colspan="2"><br />{include file="main/subheader.tpl" title=$lng.lbl_ups_handling_charge class="grey"}</td>
</tr>

<tr>
  <td><b>{$lng.lbl_ups_handling_charge_value}:</b></td>
  <td>
    <input type="text" name="handling_charge_flat" value="{$shipping_options.rss.handling_charge_flat}" style="width: 200px;" />
  </td>
</tr>

<tr>
  <td><b>{$lng.lbl_ups_handling_charge_currency}:</b></td>
  <td>
    <select name="handling_charge_currency" style="width: 200px;">
    {include file="modules/UPS_OnLine_Tools/ups_currency.tpl" selected=$shipping_options.rss.handling_charge_currency}
    </select>
  </td>
</tr>

<tr>
  <td><b>{$lng.lbl_ups_handling_charge_percent}:</b></td>
  <td>
    <input type="text" name="handling_charge_percent" value="{$shipping_options.rss.handling_charge_percent}" style="width: 200px;" />
  </td>
</tr>
