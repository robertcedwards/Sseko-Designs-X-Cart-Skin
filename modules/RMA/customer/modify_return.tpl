{*
$Id: modify_return.tpl,v 1.4 2009/04/18 06:33:06 max Exp $
    ...
    <table cellspacing="0" class="data-table" summary="{$lng.lbl_modify|escape}">
      ...
      <tr>
        ...
        <td class="buttons-row">
          ...
          {/if}
          {if $return.status eq 'A' || $return.status eq 'C'}
...
{/capture}
{include file="customer/dialog.tpl" content=$smarty.capture.dialog title=$lng.lbl_modify}
