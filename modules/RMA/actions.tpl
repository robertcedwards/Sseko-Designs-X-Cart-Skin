{*
$Id: actions.tpl,v 1.11 2009/05/18 08:26:25 igoryan Exp $
vim: set ts=2 sw=2 sts=2 et:
*}
{capture name=dialog}

{include file="main/language_selector.tpl" script="returns.php?mode=actions&"}

<form action="returns.php" method="post" name="action_form">
<input type="hidden" id="mode" name="mode" value="actions" />
<input type="hidden" id="user_action" name="user_action" value="update" />

{include file="main/check_all_row.tpl" style="line-height: 170%;" form="action_form" prefix="to_delete"}
...
{/foreach}
<tr> 
  <td class="TopLabel" colspan="2"><br />{include file="main/subheader.tpl" title=$lng.lbl_new_action}</td>
</tr>
<tr>
  <td>&nbsp;</td>
  <td colspan="2"><input type="text" name="new" value="" size="32" /></td>
</tr> 
<tr>
  <td colspan="2">&nbsp;</td>
</tr>
