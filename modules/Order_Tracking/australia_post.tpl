{*
$Id: australia_post.tpl,v 1.6 2009/04/20 05:19:28 joy Exp $
...
<form action="http://www.eparcel.com.au/tower/VisSys/login" method="post" name="getTrackNum" target="_blank" onsubmit="javascript: return validateSubmit(this);">
  ...
  <tr>
    <td><input name="radio1" type="radio" value="Article" onclick="document.getTrackNum.articleConsChoice.value='Article';" checked/>{$lng.lbl_article}</td>
    <td><input name="radio1" type="radio" value="Consignment" onclick="document.getTrackNum.articleConsChoice.value='Consignment';"/>{$lng.lbl_consignment}</td>
