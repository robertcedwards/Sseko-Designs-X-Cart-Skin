{*
$Id: wl_products.tpl,v 1.43 2009/05/08 12:32:17 igoryan Exp $
...
{if $wl_products ne "" || ($active_modules.Gift_Certificates ne "" && $wl_giftcerts ne "")}
          ...
          <table cellspacing="0" class="item width-100" summary="{$lng.lbl_wish_list|escape}">
              ...
              <td class="details">
                ...
                {if $product.product_options ne ""}
                  ...
                  <div class="poptions-list">
                    ...
                    {if $giftregistry eq "" && $source ne "giftreg"}
                ...
                {elseif $product.amount_remain gt 0 or $allow_edit}
                  <span class="product-price-text">
                    {include file="currency.tpl" value=$price} x {if $active_modules.Egoods && $product.distribution}1<input type="hidden"{else}<input type="text" size="3"{/if} name="quantity" id="qty_{$product.wishlistid}" value="{$product.amount}" /> = 
                  </span>
                  <span class="price">
                ...
                {if !((($wl_products and $product.amount_purchased lt $product.amount and $product.avail gt "0") or $config.General.unlimited_products eq "Y") or $main_mode eq "manager" or $product.product_type eq "C") && $product.amount gt $product.avail}
            ...
            <tr>
              ...
              <td class="buttons-row">
                ...
                {if ((($wl_products && ($product.amount_purchased lt $product.amount or $eventid eq "") && $product.avail gt "0") || $config.General.unlimited_products eq "Y") || $main_mode eq "manager" || $product.product_type eq "C") && ($login or $giftregistry ne "")}
  ...
  {if $giftregistry eq "" && $source ne "giftreg"}
    ...
    <form method="post" action="{$script_name}.php" name="sendall_form" onsubmit="javascript: return checkFormFields(this);">
