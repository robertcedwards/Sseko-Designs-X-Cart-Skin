{*
$Id: popup_image.tpl,v 1.31 2009/04/16 13:39:31 max Exp $
...
{foreach from=$images item=i name=images}
  ['{$i.image_url|escape:javascript}', '{$i.icon_url|escape:javascript}', '{$i.alt|escape:javascript}']{if !$smarty.foreach.images.last},{/if}
{/foreach}
];
...
-->
  ...
  <script type="text/javascript" src="{$SkinDir}/modules/Detailed_Product_Images/icons_box.js"></script>

  <div class="dpimages-icons-box">
    {foreach from=$images item=i name=images}
      {if $config.Detailed_Product_Images.det_image_icons_limit lte 0 || $config.Detailed_Product_Images.det_image_icons_limit > $smarty.foreach.images.index}
