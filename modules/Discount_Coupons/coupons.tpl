{*
$Id: coupons.tpl,v 1.46.2.1 2010/01/14 13:54:52 ferz Exp $
...
<tr>
  <td colspan="7"><br />
  <input type="button" value="{$lng.lbl_delete_selected|strip_tags:false|escape}" onclick="javascript: if (checkMarks(this.form, new RegExp('^posted_data\\[\\w+\\]\\[to_delete\\]', 'ig'))) {ldelim} document.couponsform.mode.value='delete';document.couponsform.submit();{rdelim}" />
  &nbsp;&nbsp;&nbsp;&nbsp;
