{*
$Id: template_sample_1.tpl,v 1.7 2009/04/18 06:33:05 max Exp $
  ...
  <td>
    ...
    <tr>
      ...
      <td width="100%" valign="top">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td width="100%"><img src="{$TplImages}/company_logo.gif" width="103" height="31" alt="" /></td>
        </tr>
        </table><br />
        ...
        <tr>
          <td valign="bottom">
            <img src="{$TplImages}/spacer.gif" width="1" height="350" alt="" /><br />
            <img src="{$TplImages}/theme.jpg" alt="" />
          </td>
          <td valign="top">
...
{$giftcert.message|escape:"html"|replace:"\n":"<br />"}
            ...
            <tr>
              <td><img src="{$TplImages}/delim.gif" width="100%" height="4" alt="" /></td>
            </tr>
            </table>
