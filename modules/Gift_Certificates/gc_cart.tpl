{*
$Id: gc_cart.tpl,v 1.24 2009/05/07 11:34:25 igoryan Exp $
        ...
        <td class="details">
          ...
          {elseif $gc.send_via eq "P"}
            ...
            <div class="giftcert-item-row">
              ...
              {$gc.recipient_address}, {$gc.recipient_city}, {if $config.General.use_counties eq "Y"}{$gc.recipient_countyname} {/if}{$gc.recipient_state} {$gc.recipient_country} {$gc.recipient_zipcode}
            </div>
          ...
          <div class="giftcert-item-row">
            ...
            <span class="price">{include file="currency.tpl" value=$gc.amount}</span>
            <span class="market-price">{include file="customer/main/alter_currency_value.tpl" alter_currency_value=$gc.amount}</span>
          </div>

        </td>
      </tr>

      {if $active_modules.Wishlist ne "" && $wl_giftcerts ne ""}
