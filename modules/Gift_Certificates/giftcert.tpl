{*
$Id: giftcert.tpl,v 1.62 2009/05/18 08:26:25 igoryan Exp $
...
<td align="left"><input type="text" name="purchaser" size="30" value="{if $usertype eq "A" && $smarty.get.mode eq 'add_gc'}{$config.Company.company_name|escape}{elseif $giftcert.purchaser}{$giftcert.purchaser|escape:"html"}{else}{if $userinfo.firstname ne ''}{$userinfo.firstname|escape} {/if}{$userinfo.lastname|escape}{/if}" /></td>
</tr>
...
<td><font class="Star">*</font></td>
<td align="left"><input type="text" name="recipient_zipcode" size="30" value="{$giftcert.recipient_zipcode|escape}" onchange="javascript: check_zip_code_field(document.forms['gccreate'].recipient_country, document.forms['gccreate'].recipient_zipcode);" /></td>
</tr>
...
{if (($usertype eq "A" or ($usertype eq "P" and $active_modules.Simple_Mode ne "")) and $smarty.get.mode eq "modify_gc")}
...
{/if}
{else}
<td><input type="button" value="{$lng.lbl_gc_create|escape}" onclick="javascript: formSubmit();" /></td>
{/if}
</tr>
</table>
</center>
