...
function writeZIndexFrame(scPath){
  if(isIE){
    document.write("<iframe id=\"zIndexFrame\" style=\"z-index:10;position:absolute;display:none;\" scrolling=\"no\" frameborder=\"0\" src='"+scPath+"blank.gif'></iframe>");
  }
}
...
function insertLink(url,title,target)
  ...
  if(oSel.parentElement)
    ...
    if(oSel.text=="")
	  ...
	  if(isset(title) && title!="") oSel.text=title;
      else oSel.text=url;
