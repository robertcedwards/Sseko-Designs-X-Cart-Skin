{*
$Id: news_subscribers.tpl,v 1.27 2009/09/09 08:12:04 igoryan Exp $
...
<option value="Y"{if !$not_empty_list} selected="selected"{/if}>{$lng.lbl_news_list_all_lists}</option>
</select></td></tr>
