{*
$Id: common_templates.tpl,v 1.51 2009/04/02 07:25:00 joy Exp $
...
{elseif $main eq "login_incorrect" or $main eq "antibot_error" or $main eq "disabled"}
{include file="main/error_login_incorrect.tpl" is_remember="Y"}

{elseif $main eq "need_login"}
{include file="main/error_login.tpl" is_remember="Y"}
