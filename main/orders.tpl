{*
$Id: orders.tpl,v 1.83 2009/10/07 11:23:12 igoryan Exp $
...
<tr>
  ...
  <td>{html_select_date prefix="Start" time=$search_prefilled.start_date|default:$start_date start_year=$config.Company.start_year end_year=$config.Company.end_year}</td>
</tr>

<tr> 
  <td width="5">&nbsp;</td>
  <td class="OptionLabel" align="right"><label>{$lng.lbl_to}:</label></td>
  <td>{html_select_date prefix="End" time=$search_prefilled.end_date|default:$end_date start_year=$config.Company.start_year end_year=$config.Company.end_year display_days=yes}</td>
</tr>
...
<br />
{include file="main/advanced_search_options.tpl" mark="1" title=$lng.lbl_advanced_search_options extra=' width="100%"'}
<br />
...
<tr>
  ...
  <td>
  <input type="text" name="posted_data[provider]" size="30" value="{$search_prefilled.provider|escape}" style="width:70%" />
  </td>
</tr>
{/if}
