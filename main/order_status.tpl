{*
$Id: order_status.tpl,v 1.13 2008/11/25 09:01:05 max Exp $
...
{/if}
  ...
  {if $status eq "A" || $display_preauth}<option value="A"{if $status eq 'A'} selected="selected"{/if}>{$lng.lbl_pre_authorized}</option>{/if}
