{*
$Id: popup_category.tpl,v 1.5 2009/09/01 12:07:04 igoryan Exp $
...
var wnd_opener = window.opener.document;
...
{include file="main/category_selector.tpl" field="categoryid" extra=' size="20" style="width: 100%" ondblclick="javascript: setCategoryInfo();" onchange="javascript: showTitle(this.options[this.selectedIndex].text, 'left');"' categoryid=$smarty.get.categoryid}<br /><br />
<center>
