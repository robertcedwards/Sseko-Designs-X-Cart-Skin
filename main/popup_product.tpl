{*
$Id: popup_product.tpl,v 1.38 2009/10/27 12:20:29 vvs Exp $
...
var id_obj = {if $smarty.get.field_productid ne ""}window.opener.document.{$smarty.get.field_productid} ? window.opener.document.{$smarty.get.field_productid} : window.opener.document.getElementById('{$smarty.get.field_productid}'){else}null{/if};

var name_obj = {if $smarty.get.field_product ne ""}window.opener.document.{$smarty.get.field_product} ? window.opener.document.{$smarty.get.field_product} : window.opener.document.getElementById('{$smarty.get.field_product}'){else}null{/if};
...
<form method="get" onsubmit="javascript: return checkCategory ()" name="cat_form" action="popup_product.php">
