/* $Id: image_manipulations.js,v 1.11 2009/04/03 09:36:21 joy Exp $ */
/*
...
function ajax_call_image_manipulations(request) {
	...
	ajax_script = ((current_area == "A") ? "/admin" : "/provider") + "/ajax_image_manipulations.php";
	$.getJSON(xcart_web_dir + ajax_script, request, function (data, textStatus) { ajax_callback_image_manipulations(data, request);});
}
