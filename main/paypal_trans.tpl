{*
$Id: paypal_trans.tpl,v 1.10 2009/10/26 13:13:06 igoryan Exp $
...
{if !$data.main.update_date && $data.method eq 'US'}
...
{if $data.main.payment_status eq 'Pending' && $data.main.pendingreason}
...
{elseif $data.main.payment_status eq 'Reversed' && $data.main.reasoncode}
