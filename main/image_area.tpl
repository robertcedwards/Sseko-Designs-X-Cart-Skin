{*
$Id: image_area.tpl,v 1.17 2009/05/15 12:17:09 joy Exp $
...
var  geid = "{$geid}";
var  lbl_modified = "{$lng.lbl_modified}";
var  lbl_no_image_uploaded= "{$lng.lbl_no_image_uploaded}";

var  change_buttons = new Array();
change_buttons['T'] = "{$lng.lbl_upload_thumbnail}";
change_buttons['P'] = "{$lng.lbl_upload_image}";
-->
</script>

<script type="text/javascript" src="{$SkinDir}/main/image_manipulations.js"></script>
...
<tr {if !$product.is_pimage}style="display: none;" id="edit_product_image_reset2"{/if}>
...
<tr id="Pimage_button3" {if !$product.is_pimage}style="display: none;"{/if}>
<td class="ProductDetails" valign="top" align="left">
...
<td class="ProductDetails" valign="top" align="left">
  ...
  <td class="Product_Details" valign="top" align="left">
    &nbsp;&nbsp;
    <a href="javascript:void(0);" class="NeedHelpLink" onmouseover="javascript: viewHelp('help_need_help', this);">{$lng.lbl_need_help}</a>
    <div id="help_need_help" class="NeedHelpBox" style="display:none">{$lng.txt_need_thumbnail_help}</div>
  </td></tr>
  </table>
...
<tr>
<td class="ProductDetails" valign="top" align="left" {if !$product.is_pimage or !$gdlib_enabled}style="padding: 4px 4px 10px 4px;"{/if}>
...
<tr id="tr_generate_thumbnail" {if !$product.is_pimage}style="display: none;"{/if}>
...
<tr {if !$product.is_thumbnail}style="display: none;" id="edit_image_reset2"{/if}>
  <td class="SubHeaderLine" style="BACKGROUND-COLOR: #d3d3d3"><img src="{$ImagesDir}/spacer.gif" class="Spc" alt="" /><br /></td>
</tr>
...
<tr id="Timage_button3" {if !$product.is_thumbnail}style="display: none;"{/if}>
<td class="ProductDetails" valign="top" align="left">
