  ...
  {if $giftcerts ne ''}
    {foreach from=$giftcerts item=gc}
      <tr>
        <td>&nbsp;</td>
        <td{if $is_nomail eq 'Y'} class="invoice-product-column"{/if}>
          <p{if $is_nomail ne 'Y'} nowrap="nowrap"{/if}>{$lng.lbl_gift_certificate}: {$gc.gcid}<p/>
          <div{if $is_nomail ne 'Y'} style="padding-left: 10px; white-space: nowrap;"{/if}>
            {if $gc.send_via eq "P"}
              ...
              {/if}
              {$gc.recipient_state} {$gc.recipient_country}, {$gc.recipient_zipcode}<br />
        ...
        {/if}
        <td {if $is_nomail eq 'Y'}class="invoice-price-column"{else}align="right" nowrap="nowrap"{/if}>{include file="currency.tpl" value=$gc.amount}&nbsp;&nbsp;</td>
        <td {if $is_nomail eq 'Y'}class="invoice-quantity-column"{else}align="center"{/if}>1</td>
        <td {if $is_nomail eq 'Y'}class="invoice-total-column"{else}align="right" nowrap="nowrap" style="padding-right: 5px;"{/if}>{include file="currency.tpl" value=$gc.amount}</td>
      </tr>
    {/foreach}
  {/if}
...
<table cellspacing="0" {if $is_nomail eq 'Y'}class="invoice-totals"{else}cellpadding="0" width="100%" border="0"{/if} summary="{$lng.lbl_total|escape}">
  ...
  <tr>
    ...
    <td {if $is_nomail eq 'Y'}class="invoice-total-value"{else}style="white-space: nowrap; padding-right: 5px; height: 20px; text-align: right;"{/if}>{include file="currency.tpl" value=$order.display_subtotal}</td>
  </tr>
  ...
  {if $order.discount gt 0}
    <tr>
      ...
      <td {if $is_nomail eq 'Y'}class="invoice-total-value"{else}style="white-space: nowrap; padding-right: 5px; height: 20px; text-align: right;"{/if}>{include file="currency.tpl" value=$order.discount}</td>
    </tr>
  {/if}
  ...
  {if $order.coupon and $order.coupon_type ne "free_ship"}
    <tr>
      ...
      <td {if $is_nomail eq 'Y'}class="invoice-total-value"{else}style="white-space: nowrap; padding-right: 5px; height: 20px; text-align: right;"{/if}>{include file="currency.tpl" value=$order.coupon_discount}</td>
    </tr>
  {/if}
  ...
  {if $order.discounted_subtotal ne $order.subtotal}
    <tr>
      ...
      <td {if $is_nomail eq 'Y'}class="invoice-total-value"{else}style="white-space: nowrap; padding-right: 5px; height: 20px; text-align: right;"{/if}>{include file="currency.tpl" value=$order.display_discounted_subtotal}</td>
    </tr>
  {/if}
  ...
  {if $config.Shipping.enable_shipping eq 'Y'}
    <tr>
      ...
      <td {if $is_nomail eq 'Y'}class="invoice-total-value"{else}style="white-space: nowrap; padding-right: 5px; height: 20px; text-align: right;"{/if}>{if $order.coupon and $order.coupon_type eq "free_ship"}{include file="currency.tpl" value=0}{else}{include file="currency.tpl" value=$order.display_shipping_cost}{/if}</td>
    </tr>
  {/if}
  ...
  {if $order.applied_taxes and $order.extra.tax_info.display_taxed_order_totals ne "Y"}
    {foreach key=tax_name item=tax from=$order.applied_taxes}
      <tr>
        ...
        <td {if $is_nomail eq 'Y'}class="invoice-total-value"{else}style="white-space: nowrap; padding-right: 5px; height: 20px; text-align: right;"{/if}>{include file="currency.tpl" value=$tax.tax_cost}</td>
      </tr>
    {/foreach}
  {/if}
  ...
  {if $order.payment_surcharge ne 0}
    <tr>
      ...
      <td {if $is_nomail eq 'Y'}class="invoice-total-value"{else}style="white-space: nowrap; padding-right: 5px; height: 20px; text-align: right;"{/if}>{include file="currency.tpl" value=$order.payment_surcharge}</td>
    </tr>
  {/if}
  ...
  {if $order.giftcert_discount gt 0}
    <tr>
      ...
      <td {if $is_nomail eq 'Y'}class="invoice-total-value"{else}style="white-space: nowrap; padding-right: 5px; height: 20px; text-align: right;"{/if}>{include file="currency.tpl" value=$order.giftcert_discount}</td>
    </tr>
  {/if}

  <tr>
    <td {if $is_nomail eq 'Y'}class="invoice-line"{else}height="4"{/if} colspan="2"><img src="{$ImagesDir}/spacer.gif" {if $is_nomail ne 'Y'}style="height: 2px; width: 100%; background: #58595b none;"{/if} alt="" /></td>
  </tr>
  ...
  <tr>
    ...
    <td {if $is_nomail eq 'Y'}class="invoice-total-value-fin"{else}style="white-space: nowrap; padding-right: 5px; height: 25px; background: #cccccc none; text-align: right;"{/if}><strong>{include file="currency.tpl" value=$order.total}</strong></td>
  </tr>
  ...
  <table cellspacing="1" {if $is_nomail eq 'Y'}class="invoice-giftcerts"{else}cellpadding="0" width="100%" border="0"{/if} summary="{$lng.lbl_gift_certificates|escape}">
    ...
    {foreach from=$order.applied_giftcerts item=gc}
      <tr>
        ...
        <td {if $is_nomail eq 'Y'}class="invoice-giftcert-cost"{else}style="text-align: right; white-space: nowrapl padding-right: 5px;"{/if}>{include file="currency.tpl" value=$gc.giftcert_cost}</td>
      </tr>
    {/foreach}
