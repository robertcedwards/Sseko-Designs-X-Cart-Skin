{*
$Id: paypal_flow_step3.tpl,v 1.1 2009/10/22 12:07:08 max Exp $
  ...
  <form action="payment_methods.php" method="post" name="paypalflowstep3">
    ...
    <ul>
      <li class="selected">
        ...
        {if $paypal_enabled && $paypal_solution}
...
<script type="text/javascript" src="{$SkinDir}/admin/main/paypal_flow.js"></script>
