{*
$Id: html_catalog.tpl,v 1.33 2009/09/01 12:07:03 igoryan Exp $
vim: set ts=2 sw=2 sts=2 et:
*}
<script type="text/javascript" src="{$SkinDir}/admin/main/html_catalog.js"></script>
...
<tr>
  ...
  <select name="start_category" style="width: 250px;">
    ...
    <option value="{$c.categoryid_path}">{$c.category|amp}</option>
    {/foreach}
  </select>
  </td>
</tr>
      ...
      <table cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td style="padding-left: 5px; vertical-align: top; padding-top: 3px;">
            <div class="HCKeywords">
              <a href="javascript:void(0);" class="NeedHelpLink" onmouseover="javascript: viewHelp('help_{$tk}', this);">{$lng.lbl_need_help}</a>
              <div id="help_{$tk}" class="NeedHelpBox" style="display: none;">{$lng.txt_html_catalog_template_help|substitute:"rtags":$t.rtags:"nrtags":$t.nrtags:"length":$template_max_length}</div>
            </div>
          </td>
        </tr>
      </table>
