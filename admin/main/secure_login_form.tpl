{*
$Id: secure_login_form.tpl,v 1.20 2009/06/11 07:27:10 joy Exp $
...
{if $js_enabled}
{include file="buttons/submit.tpl" href="javascript:void(document.secureform.submit());" js_to_href="Y" type="input"}
{else}
