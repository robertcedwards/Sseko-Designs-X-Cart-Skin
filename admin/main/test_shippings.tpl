{*
$Id: test_shippings.tpl,v 1.32 2009/09/09 08:12:04 igoryan Exp $
...
<tr valign="middle">
  ...
  <td>&nbsp;</td>
  <td nowrap="nowrap">
  <input type="text" id="o_zipcode" name="origin[zipcode]" size="32" maxlength="32" value="{$orig_address.zipcode}" onchange="javascript: check_zip_code_local(true);" />
  </td>
</tr>
...
{section name=country_idx loop=$countries}
    <option value="{$countries[country_idx].country_code}"{if $userinfo.s_country eq $countries[country_idx].country_code || ($countries[country_idx].country_code eq $orig_address.country and $userinfo.s_country eq "")} selected="selected"{/if}>{$countries[country_idx].country}</option>
{/section}
  </select>
  </td>
</tr>
...
<tr valign="middle">
  ...
  <td>&nbsp;</td>
  <td nowrap="nowrap">
  <input type="text" name="s_zipcode" size="32" maxlength="32" value="{$userinfo.s_zipcode|escape}" onchange="javascript: check_zip_code_local();" />
  </td>
</tr>
...
<tr valign="middle">
  ...
  <td nowrap="nowrap"><br />
{if $js_enabled}
{include file="buttons/submit.tpl" href="javascript:if(check_zip_code_local())document.registerform.submit()"}
{else}
