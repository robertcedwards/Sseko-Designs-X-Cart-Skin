{*
$Id: patch_apply.tpl,v 1.26 2009/05/18 11:34:16 igoryan Exp $
...
{if ($could_not_patch ne "0" || $skin_descr_missing) && $mode ne "sql"}
{if $could_not_patch ne "0"}
{$lng.txt_have_could_not_patch}<br />
{/if}
{if $skin_descr_missing}
{$lng.lbl_skin_descr_missing}<br />
{/if}
