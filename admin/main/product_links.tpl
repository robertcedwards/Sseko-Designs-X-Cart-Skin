{*
$Id: product_links.tpl,v 1.34 2009/09/09 08:12:04 igoryan Exp $
...
<script src="{$SkinDir}/admin/main/product_links.js" type="text/javascript"></script>
...
{foreach from=$v.options item=o}
    <option value="{$o.optionid}"{if $o.selected eq 'Y'} selected="selected"{/if}>{$o.option_name|escape}{if $v.is_modifier eq 'Y' && $o.price_modifier ne 0} ({if $o.modifier_type ne '%'}{include file="currency.tpl" value=$o.price_modifier display_sign=1 plain_text_message=1}{else}{$o.price_modifier}%{/if}){/if}</option>
{/foreach}
</select>
{/if}
    </td>
