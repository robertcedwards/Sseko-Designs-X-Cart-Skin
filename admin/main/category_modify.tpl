{*
$Id: category_modify.tpl,v 1.62 2009/08/28 06:15:55 igoryan Exp $
...
<tr>
  ...
  <td height="10">
    <input type="text" name="category_name" id="category_name" maxlength="255" size="65" value="{$current_category.category|escape:"html"}" {if $config.SEO.clean_urls_enabled eq "Y"}onchange="javascript: if (this.form.clean_url.value == '') copy_clean_url(this, this.form.clean_url)"{/if}/>
  </td>
</tr>
...
{if $section ne "lng" && $mode ne "add" && $cat gt 0}
  <br />
