{*
$Id: page_edit.tpl,v 1.33 2009/06/26 11:53:15 joy Exp $
...
<tr>
  ...
  <td><font class="Star"></font></td>
  <td><input type="checkbox" name="show_in_menu" value="Y"{if $page_data.show_in_menu eq 'Y' || $pageid eq '0'} checked="checked"{/if} /></td>
</tr>
{/if}
...
{if $level eq "E" && $config.SEO.clean_urls_enabled eq "Y"}
