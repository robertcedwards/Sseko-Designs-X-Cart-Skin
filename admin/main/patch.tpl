{*
$Id: patch.tpl,v 1.30 2009/06/15 12:32:54 vvs Exp $
...
function patch_agree(o) {
  ...
  o.form.elements.namedItem('submit').disabled = !valid;
...
<tr>
  <td>&nbsp;</td>
  <td><input type="submit" name="submit" value="{$lng.lbl_apply|strip_tags:false|escape}" disabled="disabled" /></td>
</tr>
...
<tr>
  <td colspan="2"><br /><input type="submit" value="&nbsp;&nbsp;&nbsp;{$lng.lbl_apply|strip_tags:false|escape}&nbsp;&nbsp;&nbsp;" /></td>
</tr>
